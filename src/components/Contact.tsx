  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Telefone",
      content: "+55 21 96442-6757",
      description: "Ligue para consultas imediatas",
    },
    {
      icon: Mail,
      title: "Email",
      content: "xledrio@gmail.com",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Tem um evento em mente? Nossa equipe está pronta para criar a
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        placeholder="Corporativo, Show, Festa, etc."
                        className="hover-glow"
                      />
                    </div>
                  </div>
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Estamos aqui para ajudar você a realizar sua visão. Entre em
                contato conosco por qualquer um destes meios.
              </p>
            </div>
              ...
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <a 
                      href={info.title === 'Email' ? '#' : `tel:${info.content}`}
                      onClick={(e) => info.title === 'Email' && copyToClipboard(info.content, e)}
            ...
            <div className="p-6 bg-gradient-glow rounded-lg border border-border/50">
              ...
              <p className="text-muted-foreground mb-4">
                Entre em contato diretamente para eventos com menos de 48 horas
                de antecedência.
              </p>
              <Button variant="secondary" className="glow-secondary" asChild>
                <a href="tel:+5521964426757">Ligar Agora: +55 21 96442-6757</a>
              </Button>
            </div>
          </div>
        </div>
